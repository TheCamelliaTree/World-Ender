...
addLayer("p", {
  ...
  upgrades: {
    ...
    34: {
      title: "Challenge 2",
      description: 'Keep upgrade on reset. (Hover to see requirement. This one is pretty hard!)',
      cost: n(1000),
    ...
    41: {
      title: "Challenge 3",
      description: 'Potato growing speed is much faster. And get a new row for farm. (Hover to see requirement. This one is hard, think twice!)',
      cost: n(1),
      tooltip: 'Req: 25,000 potatoes on reset.',
    ...
    42: {
      title: "Challenge 4",
      description: 'Unlock 2 new potato varients. Also make you become more lucky. (Hover to see requirement. This one is also hard, think fast!)',
      cost: n(1),
      tooltip: 'Req: having 3 normal, giant, teen winter and winter potato at SAME TIME.',
      unlocked() { return hasMilestone('b', 6) },
      canAfford() {
        return plantAmt2(3).gte(3) && plantAmt2(4).gte(3) && plantAmt2(5).gte(3) && plantAmt2(6).gte(3)
      },
      style() { return { "width": "240px" } }
    },
  },
  clickables: {
    11: {
...
addLayer("b", {
  ...
  clickables: {
    11: {
      display() { return "Click me to do a force reset\n<i>If you want<\i>" },
